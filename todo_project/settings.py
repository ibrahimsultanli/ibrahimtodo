...
SECRET_KEY = 'django-insecure-ja1v%rq9#g6tj(5r@qhzpbgrcqzc_f)#%+$#z3up_ws-3qbwk+'
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles',  # Bu sətir olmalıdır
    'todo_app',
    'rest_framework',
]
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Statik fayllar üçün
]
